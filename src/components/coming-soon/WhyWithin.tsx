    ...
    <div className="border-t border-wi-line py-6 first:border-t-0 first:pt-0">
      <div className="flex items-baseline justify-between gap-4">
        ...
        <span className="flex items-baseline gap-1">
          <CountUp value={low} className="wi-readout text-[24px] font-semibold text-wi-black" />
          <span className="wi-readout text-[13px] text-wi-ink-300">to</span>
          <CountUp value={high} className="wi-readout text-[24px] font-semibold text-wi-black" />
      ...
      <div className="relative mt-4 h-8">
        ...
        <motion.div
          className="absolute top-1/2 h-[6px] -translate-y-1/2 rounded-full bg-wi-electric"
          style={{ left: `${left}%` }}
          initial={{ width: 0 }}
